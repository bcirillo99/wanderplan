...
export function ExpenseForm({ onSubmit, loading }: ExpenseFormProps) {
  ...
  return (
    <div className="form-stack">
      ...
      <button className="btn-primary" style={{ width: '100%', justifyContent: 'center' }}
        onClick={() => amount && desc.trim() && onSubmit({ description: desc.trim(), amount: parseFloat(amount), category: category as ExpenseCategory || null, currency: currency || null, is_estimated: isEstimated, actual_amount: null, notes: null })}
